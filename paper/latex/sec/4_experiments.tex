...
\midrule
\multirow{3}{*}{NC4K (4{,}121)} & Base SAM & --- & --- & --- & --- \\
 & Decoder-only & --- & --- & --- & --- \\
 & LLPM+Decoder & --- & --- & --- & --- \\
\bottomrule
\end{tabular}
...
Despite being trained exclusively on COD10K, the specialized decoder generalizes to CAMO: mIoU improves from 0.489 (base) to 0.677 (+18.8 points), matching the improvement pattern observed on COD10K. NC4K results are pending.
