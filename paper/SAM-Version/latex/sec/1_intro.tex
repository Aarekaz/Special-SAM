...
\begin{enumerate}
    \item Evidence that decoder-only adaptation is highly effective for promptable COD: fine-tuning only SAM's mask decoder yields +16.6 mIoU on 2,026 test images with no architecture changes.
