...
% feed-in arrows (thicker, longer horizontal run for visibility)
\draw[ar, line width=0.7pt] (emb.east) -- ++(8mm,0) |- ([yshift=2.2mm]dec.west);
\draw[ar, line width=0.7pt] (pe.east)  -- ++(8mm,0) |- ([yshift=-2.2mm]dec.west);
...
\draw[ar] (bp)  -- (bpe);
% L-shaped route into decoder left side (thicker, longer run)
\draw[ar, line width=0.7pt] (bpe.east) -- ++(8mm,0) |- ([yshift=-2.2mm]bd.west);
