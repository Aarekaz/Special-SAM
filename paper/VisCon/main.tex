...
(2)~We evaluate on COD10K (train) and generalize to CAMO and NC4K; CHAMELEON evaluation is left for future work.
(3)~Results are from single training runs without confidence intervals.
