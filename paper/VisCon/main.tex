...
\begin{figure*}[t]
    ...
    \caption{\textbf{Qualitative comparison} (center-of-mass prompts). Each row: input image, ground-truth mask, base SAM prediction, our decoder-only prediction. Base SAM tends to segment only the most salient region near the prompt, missing large portions of camouflaged objects. The specialized decoder follows true object boundaries even when coloration matches the background.}
